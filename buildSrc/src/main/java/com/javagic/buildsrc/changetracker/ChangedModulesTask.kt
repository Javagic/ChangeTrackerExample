...
import com.javagic.buildsrc.changetracker.git.JGitClient
import com.javagic.buildsrc.changetracker.project.ProjectDependents
import com.javagic.buildsrc.changetracker.project.ProjectLocator
...
import com.javagic.buildsrc.changetracker.util.rootProject
import org.gradle.api.DefaultTask
import org.gradle.api.Project
import org.gradle.api.tasks.Input
import org.gradle.api.tasks.TaskAction
import com.javagic.buildsrc.changetracker.util.changeTrackerExtension
import com.javagic.buildsrc.changetracker.util.getProperty
...
open class ChangedModulesTask : DefaultTask() {
    ...
    override fun getGroup(): String {
        return CHANGED_TRACKER_GROUP_NAME
    }

    @TaskAction
    fun taskAction() {
        val projectDependents = ProjectDependents(rootProject)
        println(projectDependents.getAllDependents(rootProject))
